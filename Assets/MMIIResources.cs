...
public static class MMIIResources
{
        public const string achievement_wave_5_survived = "CgkI3KDV4-IVEAIQBQ"; // <GPGSID>
        public const string achievement_wave_4_survived = "CgkI3KDV4-IVEAIQBA"; // <GPGSID>
